...
**Batch Jobs** are the recommended way to run outbound calling at scale — they support scheduling, concurrency control, per-call tracking, and automatic retry. **Campaigns** are a simpler option for quick, small-scale outbound calls.
