...
| Method | Path | Auth | Description |
|--------|------|------|-------------|
| `POST` | `/campaigns` | D, A | Create campaign |
| `GET` | `/campaigns` | M, D, A | List campaigns |
| `GET` | `/campaigns/{id}` | JWT | Get campaign details |
| `PUT` | `/campaigns/{id}` | D, A | Update campaign |
| `DELETE` | `/campaigns/{id}` | D, A | Delete campaign |
| `POST` | `/campaigns/{id}/import_csv` | JWT | Import numbers from CSV |
| `POST` | `/campaigns/{id}/add_numbers` | JWT | Add numbers manually |
| `DELETE` | `/campaigns/{id}/phone_numbers` | JWT | Delete number |
| `POST` | `/campaigns/{id}/start` | JWT | Start campaign |
| `GET` | `/campaigns/{id}/status` | JWT | Campaign status |
