...
| **Campaign** | A manual or CSV-imported collection of phone numbers for outbound calling, simpler than batch jobs. |
...
| **Disposition** | The outcome/result category of a call (e.g., "successful-transfer", "hung-up", "do-not-call"). |
